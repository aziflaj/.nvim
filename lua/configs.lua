...
require('nvim-treesitter.configs').setup {
  ensure_installed = { 'go', 'ruby', 'typescript', 'vim', 'lua', 'bash', 'diff', 'python' },
  highlight = {
    enable = true,
  },
  endwise = {
...
require("auto-session").setup {
  auto_restore = true,
  auto_save = true,
  root_dir = vim.fn.expand("$HOME").."/.config/nvim/sessions/",
}
...
lspconfig.jedi_language_server.setup({
  ...
  root_dir = function(fname)
    return lspconfig.util.root_pattern("setup.py", "setup.cfg", "pyproject.toml", ".git")(fname) or
